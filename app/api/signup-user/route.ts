...
export async function POST(req: Request) {
    try {
        ...
        return new Response('User Successfully Created ', { status: 200, statusText: "User Successfully Created" })
        ...
        if (
            ...
            return new Response('Internal Error', { status: 409, statusText: 'Username or Email already exists' })
        } else {
